...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (
        ...
        logError("AUTHORIZATION", ("Failed authorization attempt on [fetch-family.php]. Username: " . $_SERVER['PHP_AUTH_USER'] . " / Password: " . $_SERVER['PHP_AUTH_PW']));
        echo 'Authorization required';
        exit;
    }

    $fam_id = intval($_POST['fam-id']);

    // If the credentials are valid, continue with the API logic
    require('private-functions.php');
    echo json_encode(getFamily($fam_id));
}
?>